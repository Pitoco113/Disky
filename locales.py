...
class LangPT_BR:
    ...
    def get() -> dict:
        return {
            ...
            "card_organized_count": "arquivos organizados",
            "card_duplicates": "🔁 {count} duplicatas\nencontradas",
            "card_duplicates_count": "duplicatas encontradas",
            "card_space": "💾 {size} MB\nliberados",
            "card_space_count": "MB recuperados",
            ...
            "no_folders": "Nenhuma pasta monitorada.\nClique em + para adicionar.",
            "organizing": "Organizando...",
            "scanning": "Escaneando...",
            "select_folder": "Selecione uma pasta para monitorar",
            ...
            "scan_done_status": "✅  {count} grupos de duplicatas encontrados.",
            "no_folder_selected": "Adicione uma pasta primeiro!",
            "installed_msg": "✅  Disky instalado como app do Windows!",
            "installed_title": "✅  Instalado!",
            "installed_body": "Disky foi instalado!\n\n📦 App: {exe}\n📌 Atalho: {desktop}\n\nCriado por PITOCO113 🇧🇷",
            "install_error": "Não foi possível instalar o Disky.",
            "error": "Erro",
            "running_bg": "Rodando em segundo plano",
...
class LangEN:
    ...
    def get() -> dict:
        return {
            ...
            "card_organized_count": "files organized",
            "card_duplicates": "🔁 {count} duplicates\nfound",
            "card_duplicates_count": "duplicates found",
            "card_space": "💾 {size} MB\nfreed",
            "card_space_count": "MB recovered",
            "label_recent": "🕐  Recent activity:",
            "label_stats": "📊  Stats since start:",
            "no_activity": "No activity yet.\nAdd a folder to watch!",
            "no_folders": "No folders watched.\nClick + to add one.",
            "organizing": "Organizing...",
            "scanning": "Scanning...",
            "select_folder": "Select a folder to watch",
            ...
            "scan_done_status": "✅  {count} duplicate groups found.",
            "no_folder_selected": "Add a folder first!",
            "installed_msg": "✅  Disky installed as a Windows app!",
            "installed_title": "✅  Installed!",
            "installed_body": "Disky has been installed!\n\n📦 App: {exe}\n📌 Shortcut: {desktop}\n\nCreated by PITOCO113 🇧🇷",
            "install_error": "Could not install Disky.",
            "error": "Error",
            "running_bg": "Running in background",
